    ...
    return (()=>{
        ...
        var e = {
            4567: (e,t,i)=>{
                ...
                class l extends a.Disposable {
                    constructor(e, t) {
                        ...
                        this._renderRowsDebouncer = new n.TimeBasedDebouncer(this._renderRows.bind(this)),
                        this._refreshRows(),
                        ...
                        this._screenDprMonitor = new h.ScreenDprMonitor(window),
                        this.register(this._screenDprMonitor),
                        this._screenDprMonitor.setListener((()=>this._refreshRowsDimensions())),
                        this.register((0,
                        o.addDisposableDomListener)(window, "resize", (()=>this._refreshRowsDimensions()))),
                        this.register((0,
                        a.toDisposable)((()=>{
                            (0,
                            c.removeElementFromParent)(this._accessibilityTreeRoot),
                    ...
                    _handleChar(e) {
                        ...
                        21 === this._liveRegionLineCount && (this._liveRegion.textContent += s.tooMuchOutput)),
                        r.isMac && this._liveRegion.textContent && this._liveRegion.textContent.length > 0 && !this._liveRegion.parentNode && setTimeout((()=>{
                            this._accessibilityTreeRoot.appendChild(this._liveRegion)
                        }
                        ), 0))
                    }
                    _clearLiveRegion() {
                        ...
                        this._liveRegionLineCount = 0,
                        r.isMac && (0,
                        c.removeElementFromParent)(this._liveRegion)
                    }
                    _handleKey(e) {
                    ...
                    _handleNewLink(e) {
                        ...
                        this._renderService && this._linkCacheDisposables.push(this._renderService.onRenderedViewportChange((e=>{
                            const t = 0 === e.start ? 0 : e.start + 1 + this._bufferService.buffer.ydisp
                              , i = this._currentLink ? this._lastMouseEvent : void 0;
                            if (this._clearCurrentLink(t, e.end + 1 + this._bufferService.buffer.ydisp),
                            i && this._element) {
            ...
            3236: (e,t,i)=>{
                ...
                class I extends w.CoreTerminal {
                    ...
                    _handleScreenReaderModeOptionChange(e) {
                        var t;
                        e ? !this._accessibilityManager && this._renderService && (this._accessibilityManager = new _.AccessibilityManager(this,this._renderService)) : (null === (t = this._accessibilityManager) || void 0 === t || t.dispose(),
                    ...
                    open(e) {
                        ...
                        this.options.screenReaderMode && (this._accessibilityManager = new _.AccessibilityManager(this,this._renderService)),
            ...
            3107: function(e, t, i) {
                ...
                let c = class extends a.Disposable {
                    ...
                    _createElement(e) {
                        ...
                        return s && s > this._bufferService.cols && (i.style.display = "none"),
            ...
            1296: function(e, t, i) {
                ...
                let g = 1
                  , p = class extends _.Disposable {
                    constructor(e, t, i, s, r, a, c, l, u, v) {
                        ...
                        this._rowFactory = r.createInstance(o.DomRendererRowFactory, document),
                        ...
                        _.toDisposable)((()=>{
                            ...
                            (0,
                            n.removeElementFromParent)(this._rowContainer, this._selectionContainer, this._themeStyleElement, this._dimensionsStyleElement)
                        }
                        )))
                    }
                    _updateDimensions() {
                    ...
                    _injectCss(e) {
                        ...
                        t += `${this._terminalSelector} .xterm-fg-${a.INVERTED_DEFAULT_COLOR} { color: ${l.color.opaque(e.background).css}; }${this._terminalSelector} .xterm-bg-${a.INVERTED_DEFAULT_COLOR} { background-color: ${e.foreground.css}; }`,
                    ...
                    _setCellUnderline(e, t, i, s, r, n) {
                        if (e = this._cellToRowElements[i][e],
                ...
                ;
                p = s([r(4, u.IInstantiationService), r(5, c.ICharSizeService), r(6, u.IOptionsService), r(7, u.IBufferService), r(8, c.ICoreBrowserService), r(9, c.IThemeService)], p),
                t.DomRenderer = p
            },
            3787: function(e, t, i) {
                var s = this && this.__decorate || function(e, t, i, s) {
            ...
            3230: function(e, t, i) {
                ...
                let u = class extends a.Disposable {
                    ...
                    _renderRows(e, t) {
                        this._renderer && (this._renderer.renderRows(e, t),
            ...
            8969: (e,t,i)=>{
                ...
                class m extends s.Disposable {
                    ...
                    _handleWindowsModeOptionChange(e) {
                        var t;
                        e ? this._enableWindowsMode() : (null === (t = this._windowsMode) || void 0 === t || t.dispose(),
                        this._windowsMode = void 0)
                    }
                    _enableWindowsMode() {
                ...
                class E extends h.Disposable {
                    ...
                    charAttributes(e) {
                        ...
                        for (let r = 0; r < t; r++)
                            ...
                            s.bg |= 16777215 & l.DEFAULT_ATTR_DATA.bg) : 38 === i || 48 === i || 58 === i ? r += this._extractColor(e, r, s) : 59 === i ? (s.extended = s.extended.clone(),
                ...
                t.Buffer = class {
                        ...
                        this.lines.length > 0) {
                            ...
                            if (this._rows < t)
                                for (let s = this._rows; s < t; s++)
                                    this.lines.length < t + this.ybase && (this._optionsService.rawOptions.windowsMode ? this.lines.push(new r.BufferLine(e,i)) : this.ybase > 0 && this.lines.length <= this.ybase + this.y + o + 1 ? (this.ybase--,
                                    o++,
                    ...
                    stringIndexToBufferIndex(e, t, i=!1) {
                        for (; t; ) {
                            ...
                            for (let i = 0; i < r; ++i)
                                if (s.get(i)[o.CHAR_DATA_WIDTH_INDEX] && (t -= s.get(i)[o.CHAR_DATA_CHAR_INDEX].length || 1),
                                t < 0)
                                    return [e, i];
                            e++
                        }
